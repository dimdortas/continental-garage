import{g as u,S as y}from"./gsap-CiEuWA-R.js";import{C as m}from"./data-Lg7BMD_s.js";import{p as k}from"./index-D6b1s_LE.js";u.registerPlugin(y);const h=[{n:1,title:"Showcase & Retail",body:"Showcase and retail special vehicles — a rotating floor of machines worth crossing town to stand next to."},{n:2,title:"Workshop",body:"Maintain, restore and customise vehicles in an open workshop where the craft is the attraction."},{n:3,title:"Academy",body:"Host events, workshops, lectures and master-classes that pass the knowledge on, hands first."},{n:4,title:"Community Spaces",body:"Cafés and restaurants built for lingering — where a coffee turns into a conversation about carburettors."},{n:5,title:"Analogue Culture",body:"Anything related to motoring and the analogue culture — vinyl, print, film, mechanical watches, the tactile world."},{n:6,title:"Industry Stage",body:"Unique events and presentations by industry leaders, staged where the machines actually live."},{n:7,title:"The Club",body:"Exclusive receptions for selected groups or clubs — a members’ room behind the workshop doors."}],n=360,c=250,d=104,p=c+64,g=t=>`assets/photos/icon-${t}.png`;function L(){const t=document.getElementById("engine-diagram"),s=document.getElementById("engine-accordion");if(!t||!s)return;t.innerHTML=_(),s.innerHTML=C();const l={index:document.querySelector(".engine__panel-index"),title:document.querySelector(".engine__panel-title"),body:document.querySelector(".engine__panel-body")},r=[...t.querySelectorAll(".engine-part")],a=e=>{const o=h.find(i=>i.n===e);o&&(r.forEach(i=>i.classList.toggle("is-active",+i.dataset.n===e)),l.index.textContent=m[e],l.title.textContent=o.title,l.body.textContent=o.body)};r.forEach(e=>{const o=+e.dataset.n;e.addEventListener("mouseenter",()=>a(o)),e.addEventListener("focus",()=>a(o)),e.addEventListener("click",()=>a(o)),e.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),a(o))})}),a(1),k()||(u.set(r,{opacity:0}),y.create({trigger:t,start:"top 72%",once:!0,onEnter:()=>u.to(r,{opacity:1,duration:.6,stagger:.08,ease:"power2.out"})}))}function _(){const t=h.map((s,l)=>{const r=(-90+l*(360/h.length))*(Math.PI/180),a=Math.cos(r),e=Math.sin(r),o=n+c*a,i=n+c*e,f=n+120*a,x=n+120*e,b=n+(c-58)*a,v=n+(c-58)*e,$=n+p*a,w=n+p*e;return`
    ...
    </details>`).join("")}export{h as PILLARS,L as initEngine};
